...
<form method="post">
    ...
    Book Author: <input value="<?= $data->getBook()->getAuthor(); ?>" type="text" name="title" minlength="3"
                        maxlength="50"/><br/>

    Description: <input value="<?= $data->getBook()->getDescription(); ?>" type="text" name="description"/><br/>

    Image URL: <input value="<?= $data->getBook()->getImage(); ?>" type="text" name="description"/><br/>
